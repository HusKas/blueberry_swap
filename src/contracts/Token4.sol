...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // for accounts without code, i.e. `keccak256('')`f
        bytes32 codehash;
...
contract Token4 is Context, IERC20, Ownable {
  ...
  address payable devWallet = payable(0x0d9ab939Dd25E2336731aDEc847579080eBd09D2);
  ...
  string private constant _name = "Token4";
  string private constant _symbol = "Token4";
